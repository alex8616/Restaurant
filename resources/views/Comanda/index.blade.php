...
@section('content')
        <a class="btn btn-primary mb-2" href="{{ route('comanda.create') }}">Nueva venta +</a>
    @if (session('success'))
                ...
                <tbody>
                    @foreach ($comandas as $comanda)
                        <tr>
                            ...
                            <td>{{ $comanda->cliente->Nombre_cliente }} {{ $comanda->cliente->Apellidop_cliente }} {{ $comanda->cliente->Apellidom_cliente }}</td>
                            ...
                            @endif
                            <td style="width: 50px;">
                                    <a href="{{ route('comanda.pdf', $comanda) }}" class="btn btn-info text-bold"
                                        target="_blank">Imprimir<i class="fas fa-file-pdf ml-2"></i></a>

                                    <a href="{{ route('comanda.show', $comanda) }}" class="btn btn-info">Detalles <i
